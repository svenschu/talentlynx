...
export default function Example() {
    return (
        <div className="bg-brand-aquamarine-900 py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:max-w-none">
                    <div className="text-center">
                        <h2 className="text-balance lg:text-6xl text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
                            Statement https://www.netlify.com/platform/core/edge/#edge-functions/
                        </h2>
